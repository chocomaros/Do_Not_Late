...
public class PlacePickerFragment extends Fragment implements OnCardClickListener {
    ...
    public void onResume() {
        ...
        int count = 0;
        if(stream != null) count = stream.getVisibleCardCount();
        if (count < 1) {
    ...
    private void initialiseCards() {
        ...
        Card c = new Card.Builder(this, CARD_PICKER)
                .setTitle("pick title")
                .setDescription("pick_text")
                .addAction("pick_action", ACTION_PICK_PLACE, Card.ACTION_NEUTRAL)
